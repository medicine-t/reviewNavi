      ...
      <div className="flex">
        ...
        <div className="ml-6 w-1/2">
          ...
          <div className="flex space-x-2 mb-3">
            <Badge className="px-4 py-2 text-sm" variant={parkingStatus.variant}>
              {parkingStatus.text}
            </Badge>
            <Badge className="px-4 py-2 text-sm" variant={smokingStatus.variant}>
              {smokingStatus.text}
            </Badge>
            <Badge className="px-4 py-2 text-sm" variant={privateRoomStatus.variant}>
              {privateRoomStatus.text}
            </Badge>
          </div>

          <p className="text-lg mb-2 text-gray-600 dark:text-gray-400">住所: {shop.address}</p>
          <div className="flex space-x-2 mb-3 pt-8">
            <Link href={`https://www.hotpepper.jp/str${shop.id}`} target="_blank" rel="noopener noreferrer">
              <Button type="button" className="px-12 py-8 text-lg font-bold" variant="yoyakureview">予約・もっと詳しく!</Button>
            </Link>

            <Link href={`${pathname}#shop-review`} scroll={false} rel="noopener noreferrer">
              <Button type="button" className="px-12 py-8 text-lg font-bold"variant="yoyakureview">レビュー</Button>
            </Link>
          </div>
